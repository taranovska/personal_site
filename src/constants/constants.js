export const projects = [
  ...
  },
  {
    title: "Random Person",
    description:
      "This is a full Random Person Generator using React. I used the randomuser.me API to fetch random users and display them. I used the useState and useEffect React hooks to fetch the data.",
    image: "/images/randomPerson.png",
    tags: ["React", "API"],
    source: "https://silver-souffle-65e95c.netlify.app/",
    visit: "https://github.com/taranovska/random-person-project",
    id: 1,
  },
  {
  ...
  },
  {
    title: "Filtered Menu",
    description:
      "This is a full Filtered Menu using React. I used the useState and useEffect React hooks to filter the menu.",
    image: "/images/filteredMenu.png",
    tags: ["React", "API"],
